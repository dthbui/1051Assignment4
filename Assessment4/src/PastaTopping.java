...
// This is a concrete class for a PastaTopping that extends the Topping abstract class.
public class PastaTopping extends Topping {
    ...
    public PastaTopping(String name, MealType mealType, double price) {
        // Calls the constructor of the superclass (Topping) to initialize the fields.
